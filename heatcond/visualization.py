...
# Ré-export pratique : lecteurs de fichiers FreeFEM (utilisés par les GUI/notebooks)
from .freefem import read_freefem_mesh, read_temperature_field  # noqa: F401,E402
...
def plot_temperature_comparison(
    ...
    """
    _ensure_results_dir()
    from .freefem import read_freefem_mesh, read_temperature_field
